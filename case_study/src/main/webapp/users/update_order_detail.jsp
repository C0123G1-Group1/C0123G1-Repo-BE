  ...
  <div class="container-fluid">
    <div class="row justify-content-center" style="height: 40vh">
      <div class="col-4 px-0">
        <img src="${productDAOImage}" alt="" height="100%">
      </div>
      <div class="col-4 px-0">
    ...
    <div class="row justify-content-center pt-4">
      <div class="col-5">
        ...
        <form method="post" action="/order-detail-servlet?action=update">
          <input type="text" name="orderDetailId" value="${productDAOOrderDetailId}" hidden>
<%--          <input type="text" name="customerId" value="${customerId}" hidden>--%>
          <label for="productName">Tên sản phẩm</label>
          <input class="form-control" type="text" id="productName" name="productName" size="15" value="${productDAOName}" readonly/>
          <label for="price">Giá</label>
          <input class="form-control" type="text" id="price" name="price" value="${productDAOPrice}" readonly>
          <br>
          <label for="quantity">Số lượng</label>
          <input class="form-control" type="text" id="quantity" name="quantity" value="${productDAOQuantity}" required>
          <br>
          <div class="d-flex justify-content-between">
            <button style="border-radius: 3px; flex:1" class="btn btn-success" type="submit">Cập nhật</button>
          </div>
        </form>
      </div>
    </div>
