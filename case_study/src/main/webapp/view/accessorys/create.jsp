    ...
    <div class="card border-5">
        <div class="card-body">
            <form action="/accessory?action=create" method="post">
                ...
                <div>
                    <button type="submit" class="btn btn-outline-primary " onclick="window.location.href='/accessory'">Quay lại</button>
...
<%--            <form method="post" action="/accessory?action=create">--%>
<%--                <label>Name</label>--%>
